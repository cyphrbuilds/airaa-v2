...
import { Pin, Shield, Crown, Plus } from 'lucide-react'
...
import { ComposeAnnouncementModal } from '@/components/announcements'
import { useGuild } from '@/lib/guild-context'
import { getGuildAnnouncements, getUserRoleInGuild, addAnnouncement } from '@/lib/mock-data'
...
export default function AnnouncementsPage() {
  ...
  const [announcements, setAnnouncements] = useState(() => getGuildAnnouncements(guildId))
  ...
  const handleCreateAnnouncement = (data: { title: string; content: string; pinned: boolean }) => {
    const newAnnouncement = addAnnouncement(guildId, data)
            ...
            {sortedAnnouncements.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-zinc-500 max-w-sm">
                  {isAdminOrMod 
                    ? "Create the first announcement to share important updates with your community."
